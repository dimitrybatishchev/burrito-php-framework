...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="/framework/static/css/bootstrap.css" rel="stylesheet">

    <!-- Add custom CSS here -->
    <link href="/framework/static/css/sb-admin.css" rel="stylesheet">
    <link rel="stylesheet" href="/framework/static/font-awesome/css/font-awesome.min.css">
    <!-- Page Specific CSS -->
...
<script src="/framework/static/js/bootstrap.js"></script>
<!-- Page Specific Plugins -->
<script src="//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
<script src="http://cdn.oesmith.co.uk/morris-0.4.3.min.js"></script>
<script src="/framework/static/js/morris/chart-data-morris.js"></script>
<script src="/framework/static/js/tablesorter/jquery.tablesorter.js"></script>
<script src="/framework/static/js/tablesorter/tables.js"></script>
</body>
</html>